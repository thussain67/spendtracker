// Bump this string (e.g. 'ledger-v2') any time you update index.html/manifest.json/icons
// and re-upload — otherwise the cached version below keeps being served offline.
